/**
 * WP-1.7b: seam reserved for WP-4.1a (buff system). Seeded empty and bound now so that WP-4.1a adds its
...
class BuffModule(@Suppress("unused") private val ctx: ServiceContext) : TerminableModule {

    override fun setup(consumer: TerminableConsumer) {
        // Reserved for WP-4.1a. Intentionally empty in WP-1.7b.
    }

    companion object {
        const val OWNER = "ramrpg-buff"
    }
}
