/**
 * WP-1.7b: seam reserved for WP-7.1 (vendors). Seeded empty and bound now so that WP-7.1 adds its
...
class VendorModule(@Suppress("unused") private val ctx: ServiceContext) : TerminableModule {

    override fun setup(consumer: TerminableConsumer) {
        // Reserved for WP-7.1. Intentionally empty in WP-1.7b.
    }

    companion object {
        const val OWNER = "ramrpg-vendor"
    }
}
