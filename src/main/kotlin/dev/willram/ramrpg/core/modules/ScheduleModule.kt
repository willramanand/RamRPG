/**
 * WP-1.7b: seam reserved for WP-7.3 (daily/weekly scheduling). Seeded empty and bound now so that WP-7.3 adds its
...
class ScheduleModule(@Suppress("unused") private val ctx: ServiceContext) : TerminableModule {

    override fun setup(consumer: TerminableConsumer) {
        // Reserved for WP-7.3. Intentionally empty in WP-1.7b.
    }

    companion object {
        const val OWNER = "ramrpg-schedule"
    }
}
