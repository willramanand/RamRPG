/**
 * WP-1.7b: seam reserved for WP-7.2 (dungeons). Seeded empty and bound now so that WP-7.2 adds its
...
class DungeonModule(@Suppress("unused") private val ctx: ServiceContext) : TerminableModule {

    override fun setup(consumer: TerminableConsumer) {
        // Reserved for WP-7.2. Intentionally empty in WP-1.7b.
    }

    companion object {
        const val OWNER = "ramrpg-dungeon"
    }
}
